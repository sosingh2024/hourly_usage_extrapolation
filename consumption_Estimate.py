...
def apirequest(zipcode,addressString,buildingType,customerClass,intervalFromDateTime='2024-01-01',intervalToDateTime='2025-01-01'):
    """
...
hourly_consumption_response=apirequest('93940','2600 Sand Dunes Dr, Monterey, CA, USA','RESIDENTIAL','RESIDENTIAL','2024-01-01',intervalToDateTime)

hourly_consumption,daily_consumption=get_typical_consumption(hourly_consumption_response)

genability_hourly_values = get_genability_values('./jsonfold/hourly_respone_from_genability_CA_4.json')
